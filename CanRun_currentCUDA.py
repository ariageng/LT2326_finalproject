...
class SwedishDifficultyGenerator:
    def __init__(
        self,
        base_model: str = "AI-Sweden-Models/gpt-sw3-1.3B",  # Better for Swedish text generation
        device_id: int = 2,
    ...
    def format_prompt(
        ...
        return f"""AVANCERAD SPRÅKTRANSFORMATION
----------------------------------------
ORIGINAL (nivå 1): Jag läser en bok
AVANCERAD (nivå 5): Min passion för litteratur manifesterar sig genom djupgående studier av skrivna verk

NU DIN TUR:
ORIGINAL (nivå {input_level}): {input_text}
AVANCERAD (nivå {target_level}):"""
